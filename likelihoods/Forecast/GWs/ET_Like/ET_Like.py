...
try:
    ...
    print('Importiong ET-Like as cobaya likelihood')
except:
...
class ET_Like(Likelihood):
    ...
    def initialize(self):
        ...
        self.ET_path=like_path +'/data/ET.txt'
        
        ET_GWs = pd.read_csv(self.ET_path, sep='\s+', header=None, names=['z', 'DL', 'dDL']).sort_values(by='z')
